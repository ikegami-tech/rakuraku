...
const mapConfig = {
    7: {
        ...
        areas: [
            ...
            { id: "会議室1", name: "会議室1", top: 37.7, left: 79.0, width: 21.0, height: 14.5, color: "rgba(0, 200, 80, 0.3)" },

            // ▼ 応接室：オレンジ系 (rgba(255, 165, 0, 0.3))
            { id: "応接室(8人)", name: "応接室(8人)", top: 70.7, left: 0.0, width: 22.5, height: 28.5, color: "rgba(255, 165, 0, 0.3)" },
