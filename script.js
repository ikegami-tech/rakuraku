...
const mapConfig = {
    7: {
        ...
        areas: [
            // ■ 左上の小さい白い四角 (ZOOM角)
            // 画像のかなり左端にあります
            { id: "ZOOM(角)", name: "ZOOM(角)", top: 22.0, left: 5.0, width: 10.0, height: 10.0 },

            // ■ 中央上の小さい白い四角 (ZOOM中)
            // 画像のかなり上端にあります
            { id: "ZOOM(中)", name: "ZOOM(中)", top: 4.0, left: 48.0, width: 10.0, height: 10.0 },

            // ■ 右側の列、上から2番目の正方形 (会議室2) 
            // 画像の右端に寄せる必要があります
            { id: "会議室2", name: "会議室2", top: 28.0, left: 80.0, width: 15.0, height: 18.0 },
            
            // ■ 右側の列、上から3番目の正方形 (会議室1)
            // 画像の右端に寄せる必要があります
            { id: "会議室1", name: "会議室1", top: 50.0, left: 80.0, width: 15.0, height: 18.0 },
            
            // ■ 左下、一番左の縦長 (応接室8人)
            // 画像の下側に寄せる必要があります
            { id: "応接室(8人)", name: "応接室(8人)", top: 72.0, left: 22.0, width: 15.0, height: 20.0 },
            
            // ■ 左下、その右隣の縦長 (応接室6人)
            // 画像の下側に寄せる必要があります
            { id: "応接室(6人)", name: "応接室(6人)", top: 72.0, left: 40.0, width: 12.0, height: 20.0 },
        ]
    },
    6: {
