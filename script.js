...
const mapConfig = {
    7: {
        ...
        areas: [
            ...
            { id: "ZOOM(角)", name: "ZOOM(角)", top: 16.0, left: 22.4, width: 8.0, height: 8.0 },
            ...
            // ※一番上のグレーの四角は除外しています
            { id: "会議室2", name: "会議室2", top: 24.5, left: 69.3, width: 8.5, height: 16.5 },
            
            // ■ 右側の列、上から3番目の正方形 (会議室1)
            { id: "会議室1", name: "会議室1", top: 41.5, left: 69.3, width: 8.5, height: 11.5 },
            
            // ■ 左下、一番左の縦長 (応接室8人)
            { id: "応接室(8人)", name: "応接室(8人)", top: 67.5, left: 22.4, width: 13.5, height: 23.5 },
